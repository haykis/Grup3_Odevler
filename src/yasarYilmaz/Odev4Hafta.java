...
//“Girdiginiz isim a veya Z harfi icermiyor” yazdirin.
		 ...
		 * boolean a_varmi=ad.contains("a"); 
		 * boolean Z_varmi=ad.contains("Z"); 
		 * if (!(a_varmi || Z_varmi)) System.out.println("Adınız  a veya Z Harfi İçermiyor"); 
		 * if (a_varmi) System.out.println("Adınızın içinde  a  harfi vardır"); 
		 * if (Z_varmi) System.out.println("Adınızın içinde  Z  harfi vardır");
		 */		
		
//Soru 3) Kullanicidan isim ve soyismini isteyin ve hangisinin daha uzun oldugunu azdirin.
